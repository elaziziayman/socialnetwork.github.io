...
<head>
<meta charset="UTF-8">
<title>${model.mc} | Search Result</title>
<script
...
<%@include file="header.jsp"%>
		...
		<div class="card border-info mb-3 w-80 " style="height: 85px;">
			...
			<tbody>
			<tr>
				<td><img src="PhotoServlet?id=${u.id}" style="width:40px; height:40px;" class="rounded-circle border border-dark">
					</td>
				<td><p class="fs-4">${u.username}</p></td>
				<td>
				<a href="profile.php?uid=${u.id}">
