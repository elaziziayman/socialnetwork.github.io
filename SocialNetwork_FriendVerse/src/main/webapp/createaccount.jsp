...
<body>
	<div class="container col-md-4 col-md-offset-4">
		<div class="card border-info mb-3">
			<div class="card-header text-center">New Account</div>
			<div class="card-body">
				<form action="saveuser.php" method="post" enctype="multipart/form-data" >
					<div class="mb-3">
						<label class="control-label">First Name</label> <input type="text"
							name="firstname" class="form-control" value="${user.firstname}" required>
						<span></span>
					</div>
					<div class="mb-3">
						<label class="control-label">Last Name</label> <input type="text"
							name="lastname" class="form-control" value="${user.lastname}" required>
						<span></span>
					</div>
					<div class="mb-3">
						<label class="control-label">Date of Birth</label> <input
							type="date" name="birthdate" class="form-control" required> <span></span>
					</div>
					<div class="mb-3">
...
<input type="file" class="form-control"  accept="image/jpeg" id="customFile" name="profilephoto" />
					...
					<div class="mb-3">
						<label class="control-label">Username</label> <input type="text"
							name="username" class="form-control" value="${user.username}" required>
						<span></span>
					</div>
					<div class="mb-3">
