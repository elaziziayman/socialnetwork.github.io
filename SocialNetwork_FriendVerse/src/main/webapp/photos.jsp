<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
		  ...
		  <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-body" >
                        <h5 class="card-title"><img src="PhotoServlet?id=${userprofile.id}" style="width:40px; height:40px;" class="rounded-circle border border-dark">
                         ${userprofile.username} added a new post</h5>
                    ...
                    <div class="container">
                        <div class="row">
                          <div class="col">
                            ...
                            <button type="button" class="btn btn-primary w-auto" onclick="likePublication(${p.id})" id="toggleBtn-${p.id}" >${p.likebutton(uidd)}</button>
                          </div>
                          <div class="col">
                            <span class="fw-bold text-secondary" id="comments">${p.numbercomments}</span>
                            <button type="button" class="btn btn-secondary  w-auto" onclick="FocusOnCommentBox(${p.id})" > Comment</button>
               ...
               <form action="addcomment.php?idP=${p.id}&uid=${userprofile.id}" method="post"> 
